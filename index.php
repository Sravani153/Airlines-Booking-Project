...
<html lang="en">
 ...
 <br>
                <a class="navbar-brand js-scroll-trigger"  style="display: flex;" href="./"><?php echo $_SESSION['setting_name'] ?></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="login1.php">Login</a></li>
